...
class MySnakeNavigationBar extends StatefulWidget {
  const MySnakeNavigationBar({super.key});



  @override
  State<MySnakeNavigationBar> createState() =>
      _MySnakeNavigationBarState();
}

class _MySnakeNavigationBarState
    extends State<MySnakeNavigationBar> {
